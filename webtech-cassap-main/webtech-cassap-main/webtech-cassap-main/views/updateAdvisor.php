...
<body>
    ...
    <?php
        ...
        $id = $_GET["id"];
        $advisor = $advisorObj -> displayAdvisor($id);
    ?>
    ...
    <div class="main-content">
        ...
        <form class="row g-3 m-5" method = "POST" action = "">
            ...
            <div class="col-md-12">
                ...
                <input type="text" name="img_link" class="form-control" value = <?= $advisor[0]["img_link"] ?>  id="inputBookLink">
...
<?php
    ...
    if(isset($_POST['submit'])){
       ...
       $results = $advisorObj -> changeAdvisor($id, $name, $bio, $class, $email , $tel, $booking_link,$img_link);
