            ...
            <table class="table table-responsive table-borderless">
                <thead>
                    <tr>
                        ...
                        <th><i class="bi bi-house px-2"></i>Class</th>
                        <th><i class="bi bi-book px-2"></i>Email</th>
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $value["email"]?></td>
                        <td><?= $value["tel"]?></td>
                        <td><a href="updateAdvisor.php?id=<?= $value["id"]?>"><i class="bi bi-pencil-square"></i></a> <a
                                href="deleteAdvisor.php?id=<?= $value["id"]?>"><i class="bi bi-trash"></i></a></td>
                    </tr>
                    <?php
                            }
                        ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!--Form-->
                        <form class="row g-3 px-5 px-2" method="POST" action="createAdvisor.php">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="url" name="img_link" class="form-control" id="inputBookLink">
                            </div>
                            <button type="submit" name="submit" class="btn btn-custum-color my-3">Add Person </button>
                        </form>
                        <!--/Form-->
                    </div>
                </div>
